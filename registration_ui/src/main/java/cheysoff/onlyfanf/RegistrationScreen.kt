...
import cheysoff.onlyfanf.design_system.R.drawable.dont_show_password_icon
import cheysoff.onlyfanf.design_system.R.drawable.show_password_icon
    ...
    ThreePartsScreen(topComposable = {
        ...
        Column(
                ...
                Row(modifier = Modifier
                    ...
                    Text(
                        modifier = Modifier.drawBehind(
                            ...
                            linePadding = 0f,
                            color = Peach
                        ), text = "Log in", style = HaveAccountLogInTextStyle
                    )
                }
            }
            ...
            Column(
                ...
                val buttonColor =
                    if (isButtonActive) LocalCustomColorScheme.current.activeButtonColor else LocalCustomColorScheme.current.inactiveButtonColor
                Button(
...
private fun BasicTextField(onValueChange: (String) -> Unit, textFieldType: TextFieldType) {
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            when (textFieldType) {
                TextFieldType.Password -> {
                    val image = if (passwordVisible) show_password_icon
                    else dont_show_password_icon
